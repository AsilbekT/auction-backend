...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='owner',
            name='property',
            field=models.ForeignKey(help_text='The property owned by the individual', on_delete=django.db.models.deletion.CASCADE, to='api.property'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(help_text='The property associated with this mortgage or debt', on_delete=django.db.models.deletion.CASCADE, to='api.property')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(help_text='The property involved in the legal proceeding', on_delete=django.db.models.deletion.CASCADE, to='api.property')),
            ],
        ),
        migrations.CreateModel(
            name='Auction',
            fields=[
                ...
                ('property', models.ForeignKey(help_text='Reference to the property being auctioned', on_delete=django.db.models.deletion.CASCADE, to='api.property')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(help_text='Reference to the property being sold', on_delete=django.db.models.deletion.CASCADE, to='api.property')),
            ],
        ),
        migrations.CreateModel(
            name='TaxLien',
            fields=[
                ...
                ('property', models.ForeignKey(help_text='The property on which the tax lien is placed', on_delete=django.db.models.deletion.CASCADE, to='api.property')),
            ],
        ),
    ]
